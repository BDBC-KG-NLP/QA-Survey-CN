...
![image](https://github.com/BDBC-KG-NLP/QA-Survey/blob/master/images/智能问答历史.png)
#### 社区问答
...
![image](https://github.com/BDBC-KG-NLP/QA-Survey/blob/master/images/zhihu.png)
...
![image](https://github.com/BDBC-KG-NLP/QA-Survey/blob/master/images/MAP1.svg)
其中R表示相关文档的总个数，position(r)表示，结果列表从前往后看，第r个相关文档在列表中的位置。比如，有三个相关文档，位置分别为1、3、6，那么AveP=1/3 * (1/1+2/3+3/6)。
最后，MAP计算所有Query的平均准确率分数：
![image](https://github.com/BDBC-KG-NLP/QA-Survey/blob/master/images/MAP2.svg)
Q为问题数目总量。
- MRR(Mean Reciprocal Rank)：是把标准答案在被评价系统给出结果中的排序取倒数作为它的准确度，再对所有的问题取平均  
![image](https://github.com/BDBC-KG-NLP/QA-Survey/blob/master/images/MRR.svg)
...
其中a+为正确答案，a-为错误答案
![image](https://github.com/BDBC-KG-NLP/QA-Survey/blob/master/images/基于表示的方法.png)
...
![image](https://github.com/BDBC-KG-NLP/QA-Survey/blob/master/images/基于比较的方法.png)
...
![image](https://github.com/BDBC-KG-NLP/QA-Survey/blob/master/images/基于预训练的方法.png)
...
![image](https://github.com/BDBC-KG-NLP/QA-Survey/blob/master/images/marginloss.svg)
...
1. ARC-I  
模型结构如下图所示
![image](https://github.com/BDBC-KG-NLP/QA-Survey/blob/master/images/ARC-I.jpg)
...
2. ARC-II
![image](https://github.com/BDBC-KG-NLP/QA-Survey/blob/master/images/ARC-II.jpg)
...
![image](https://github.com/BDBC-KG-NLP/QA-Survey/blob/master/images/dr-net.png)
介绍：  
...
![image](https://github.com/BDBC-KG-NLP/QA-Survey/blob/master/images/re2.png)
...
![image](https://github.com/BDBC-KG-NLP/QA-Survey/blob/master/images/bert.png)
*介绍*   
