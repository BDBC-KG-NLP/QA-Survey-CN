...
- [2 方法及模型](#2------)
  * [2.1 用于FAQ的方法](#21---faq---)
    + [实现方法](#----)
  * [2.2 用于问答匹配的方法](#22----------)
    + [2.2.1 规则匹配(又称“句式法”)](#221--------------)
    + [2.2.2 问题意图分类--深度学习多分类模型（CNN\DNN\LSTM\…）](#222-------------------cnn-dnn-lstm---)
    + [2.2.3 基于Siamese networks神经网络架构](#223---siamese-networks------)
    + [2.2.4 Interaction-based networks深度语义模型](#224-interaction-based-networks------)
  * [2.3 用于Chatbot的方法](#23---chatbot---)
  * [2.4 用于机器阅读理解的方法](#24------------)
  * [2.5 用于跨领域迁移学习方法](#25------------)
- [3 产品案例](#3-----)
  * [3.1 YiBot](#31-yibot)
  * [3.2 百度AnyQ](#32---anyq)
  * [3.3 腾讯知文-结构化FAQ问答引擎](#33---------faq----)
  * [3.4 阿里小蜜](#34-----)
- [4 总结](#4---)
- [5 相关资料](#5-----)
  ...
  * [3 产品举例](#3-产品举例)
  	* [3.1 YiBot](#31-YiBot)
		* [3.2 百度AnyQ](#32-百度AnyQ)
		* [3.3 腾讯知文-结构化FAQ问答引擎](#33-腾讯知文-结构化FAQ问答引擎)
		* [3.4 阿里小蜜](#34-阿里小蜜)
  * [4 总结](#4-总结)
  * [5 相关资料](#5-相关资料)
